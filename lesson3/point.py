...
class Point:
    ...
    def __init__(self, x: int, y: int):
        """Конструктор, инициализирующий экземпляр класса. Принимает координаты точки."""

        self.x = x
        self.y = y

    def __repr__(self):
        """Магический метод, возвращающий строковое представление точки для создания нового объекта класса Point."""

        return f"Point({self.x}, {self.y})"

    def __str__(self):
        """Магический метод, возвращающий строковое представление точки для пользователя."""

        return f"({self.x}, {self.y})"

    def __add__(self, other):
        """Магический метод, складывающий точки и возвращает новую точку."""
